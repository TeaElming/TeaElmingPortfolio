...
import "./App.css"
import Start from "./pages/pretty/Start"
...
function AppContent({ theme, version, toggleTheme, toggleVersion }: AppContentProps) {
  ...
  return (
    <>
      ...
      <div className="content-container">
        <Routes>
          <Route path="/" element={React.createElement(routes[version].Start)} />
