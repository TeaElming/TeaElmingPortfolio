  ...
  return (
    <section id="about" className="mobile-about">
      ...
      <ul className="skills-list">
        <li>
          <strong>Frontend:</strong> HTML5, CSS3, JavaScript, React, Bootstrap,
					TypeScript, D3.js, JFreeChart, Recharts, Leaflet
        </li>
        <li>
        ...
        <li>
          <strong>Testing:</strong> Jest, Test-Driven Development (TDD), Unit
					Testing, Postman
        </li>
        <li>
        ...
        <li>
          <strong>Software Principles:</strong> Object-Oriented Programming,
					Design Patterns, UML, SOLID Principles, Clean Code Practices,
